<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="Election_Management_System.WebForm4" %>
  ...
  <span class="dot"></span>
        ...
        <div class="vertical-menu">
            ...
            <a href="WebForm6.aspx"> CONTACT US </a>
               ...
               <asp:GridView ID="grd_edata" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
                   BorderWidth="1px" CellPadding="3" Height="99px" Width="198px" float="left" style="margin-left: 100px; margin-top: 5px">
