<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login_Page.aspx.cs" Inherits="Election_Management_System.Login_Page" %>
...
<div style="text-align:center">
  ...
  <span class="dot"></span>
        ...
        <div class="cc_news">
            <img src="FGU_Vote_Icon_Final.png" style="height: 150px; width:150px" />
           <div id="mt">
                 <h3 style="height: 29px"><center>VOTER</center></h3>
            </div>
        </div>
         <div class="cc_news">
                      <img src="computer-1331579_960_720.png" style="height: 150px; width:150px" />
             <div id="mu">
                  <h3 style="height: 29px"><center>CANDIDATE</center></h3>
             </div>
                     
        </div>
         <div class="cc_news">
            <img src="MTech-web-icons-Advisor.png" style="height: 150px; width:150px" />
             <div id="mv">
                  <h3 style="height: 29px"><center>ADMIN</center></h3>
             </div>
        ...
        <div class="vertical-menu">
         ...
         <div class="img1" style="width:1150px; height:520px;margin-top:10px;margin-left:10px;border-radius:10px;float: left;
    width: 1150px;">
         <div id="kk">
             <div class="inn_div_sty">
             <h1 class="h1">Log In</h1> <br />
             <p>with your registered account</p><br />
             <div>
                  <asp:TextBox ID="txt_usnm" runat="server" placeholder="USER NAME" ToolTip="Enter your registered username."></asp:TextBox> <br />
                 
             </div><br />
                 <div>
                 <asp:TextBox ID="txt_pwd" runat="server" placeholder="PASSWORD" ToolTip="Enter your password." TextMode="Password" ></asp:TextBox><br />
             </div><br />
            <asp:Button ID="btn_submit" runat="server" Text="Submit" OnClick="btn_submit_Click" /><br/>
                 <br />
                 <asp:Label runat="server" ID="lbl_msg" text=" " ForeColor="Red" BackColor="White"></asp:Label><br />
                 <br /><br />
            <a href="f" >Forgot Password?</a><br />
                <a href="Candid_Reg.aspx">Create Account for Candidate.</a>  <br />
                <a href="voter_accountc.aspx">Create Account for Voter.</a>  <br /> 
                ...
                <div id="footer">
            <p>
               <font color="green"> copyright</font> &copy;2015 powerade mars media
            </p>
        </div>
    </form>
</body></html>
