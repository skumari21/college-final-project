<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="Election_Management_System.WebForm2" %>
  ...
  <span class="dot"></span>
        ...
        <div class="new">
            <p style="font-size:25px;color: white">
                &nbsp;</p>
            <p style="font-size:25px;color: white">
                In order to use this website you should fall under the category of a voter or a candidate. <br />
                This website is developed with the purpose of conveying information and detail on upcoming or down going<br />
                election to people on their finger tip. For the very same purpose the<br />
                user is suppose to register under the given link.<br />
                After the user got it registered, a username and a password will be generated using which the user can login <br />
                into their account. In case a user forgets their user name and <br />
                password same can be reset it using the link “Forget password”.<br /> 
                Hence when logged in, the user can perform multiple function. <br />
                Being candidate they can register themselves for the upcoming election, see upcoming election, create symbol etc<br />
                Being voter they can see upcoming election, see registered candidate and vote.<br />
