<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm6.aspx.cs" Inherits="Election_Management_System.WebForm6" %>
...
<div style="text-align:center">
  ...
  <span class="dot"></span>
     ...
     <div id="content_top">
                <h2 style="height: 450px"><center> principle,through you may vote alone,and you may cherish the sweetest</center><br/>
        ...
        <div class="new">
         <p style="color: blue;font-size:30px;"><b> CONTACT US</b></p>
         <p style="color:white;font-size:20px;"> Address<br /></p>
          <p>   1. Flat No 121 <br />                                                   
                A9, Sector 14, Rivona Street <br />
                South of Lake Arizonaa <br />
                City, State.<br />
                Pin - 800021.    <br /><br /></p>

          <p>   2. Wazir Palace<br />
                Terra Lane, Roanapura<br />
                City, Aaonal<br />
                Pin - 67178.<br /><br /></p>
<p>
             3. Ukarineena Tiate <br />
                79 Villa, Lake Quil<br />
                City, Bulalae<br />
                Pin - 229074.<br /><br /></p>
                
         
         <p style="color:white;font-size:20px;">  Phone<br /></p>
            <p> 0612 224983<br /></p>
           <p>  0612 298457<br /></p>
         
         <p style="color:white;font-size:20px;"> Email<br /></p>
           <p>  infoeci@gmail.com<br /></p>
             <p>querynsuggestion@gmail.com<br /></p>
