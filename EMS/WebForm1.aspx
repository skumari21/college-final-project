<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Election_Management_System.WebForm1" %>
...
<div style="text-align:center">
  ...
  <span class="dot"></span>
    ...
    <div class="new">
        <p style=" color:white; height: 93px; margin-top: 24px;">
            For any democratic county, elections are vital phenomenon for its governance. <br />
            The conduction of a successful election produces various sorts of challenges to deal with.<br /> 
            As technology is at its peek these days, and governance is turning into e-governance, it very much important to <br />
            conduct elections in a handy as well as a stimulating way.<br />
            
        </p>
        <p style=" color:white; height: 98px;">
            People being super busy in making a living, time inflexibility and long method <br />
            of enrolment are some common reason that result in ignorance toward election involvement leading to<br />
            poor vote ratio, new voter and aspirant participation. With an easily available tool at one’s door it is less likely to face such negligence.<br /></p>
        <p style=" color:white; height: 57px;">
            One of the most delicate situation as election can occur in more preferable and peaceful manner with a proposition of software solution.<br />
